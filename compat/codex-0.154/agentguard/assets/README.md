...
`burn-usage-preview.mp4` is the existing five second, 1280 by 720 terminal
recording of Burn 0.2.5 against a live Claude Code scratch session. It shows
Burn pace and usage attribution, not the Codex plugin interface. The plugin lockfile includes the published Burn 0.2.5 release. It contains usage counters and a scratch
session identifier, with no transcript contents or file paths.
